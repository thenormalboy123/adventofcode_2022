if __name__ == '__main__':
    ...
    while 1:
        ...
        if markercount < 14: #fill up setof4 before doing comparison algorithm 
            ...
            if len(setof4) == len(set(setof4)): #if all char in setof4 are unique 
                ...
                setof4[markercount%14] = char #replace new char with the 1st char of the setof4 per input 
                markercount+=1 